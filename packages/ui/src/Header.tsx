    ...
    <header role="banner">
        ...
        {auth.user && (
          <div className="medplum-nav-search-container">
            <form role="search">
              ...
              <Popup className="medplum-nav-search-popover" visible={searchHintsVisible} onClose={() => setSearchHintsVisible(false)}>
      ...
      {auth.user && (
        <div className="medplum-nav-menu-container">
          ...
          <Popup className="medplum-nav-menu-popover" visible={userMenuVisible} onClose={() => setUserMenuVisible(false)}>
