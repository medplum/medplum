...
export interface SubstanceSourceMaterial {
   ...
   * organism taxonomy.
   */
  _organismName?: PrimitiveExtension;
   ...
   * The parent substance of the Herbal Drug, or Herbal preparation.
   */
  _parentSubstanceName?: (PrimitiveExtension | null)[];
   ...
   * where the animal source material has its habitat.
   */
  _geographicalLocation?: (PrimitiveExtension | null)[];
...
export interface SubstanceSourceMaterialOrganism {
   ...
   * WHO convention.
   */
  _intraspecificDescription?: PrimitiveExtension;
...
export interface SubstanceSourceMaterialOrganismAuthor {
   ...
   * plant/animal name (of any rank).
   */
  _authorDescription?: PrimitiveExtension;
}
...
export interface SubstanceSourceMaterialOrganismHybrid {
   ...
   * will be known which is maternal and which is paternal.
   */
  _maternalOrganismId?: PrimitiveExtension;
   ...
   * paternal.
   */
  _maternalOrganismName?: PrimitiveExtension;
   ...
   * organism shall be specified based on a controlled vocabulary.
   */
  _paternalOrganismId?: PrimitiveExtension;
   ...
   * shall be specified.
   */
  _paternalOrganismName?: PrimitiveExtension;
