 ...
 * the next recommended dose).
 */
export type ImmunizationRecommendationRecommendationDoseNumber = number | PrimitiveExtension | string;

/**
 * The recommended number of doses to achieve immunity.
 */
export type ImmunizationRecommendationRecommendationSeriesDoses = number | PrimitiveExtension | string;
