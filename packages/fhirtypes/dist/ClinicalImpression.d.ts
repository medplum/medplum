...
export interface ClinicalImpression {
   ...
   * the diagnosis.
   */
  _protocol?: (PrimitiveExtension | null)[];
 ...
 * The point in time or period over which the subject was assessed.
 */
export type ClinicalImpressionEffective = Period | PrimitiveExtension | string;
