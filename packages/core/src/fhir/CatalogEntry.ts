...
export interface CatalogEntry {
   ...
   */
  readonly additionalIdentifier?: Identifier[];
   ...
   */
  readonly additionalCharacteristic?: CodeableConcept[];

  /**
   * User for example for ATC classification, or.
   */
  readonly additionalClassification?: CodeableConcept[];

  /**
   * Used for example, to point to a substance, or to a device used to
   * administer a medication.
   */
  readonly relatedEntry?: CatalogEntryRelatedEntry[];
}
