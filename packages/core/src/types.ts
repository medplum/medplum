 ...
 */
export function isResource<T extends Resource = Resource>(value: unknown): value is T {
 ...
 */
export function isReference<T extends Resource>(value: unknown): value is Reference<T> & { reference: string } {
