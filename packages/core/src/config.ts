...
export interface MedplumSourceInfraConfig {
  ...
  eksEnabled?: ValueOrExternalSecret<boolean>;
  ecsEnabled?: ValueOrExternalSecret<boolean>;
  eksNodeInstanceType?: ValueOrExternalSecret<string>;
  eksDesiredNodeCount?: ValueOrExternalSecret<number>;
  eksMinNodeCount?: ValueOrExternalSecret<number>;
  eksMaxNodeCount?: ValueOrExternalSecret<number>;
  eksKubernetesVersion?: ValueOrExternalSecret<string>;
  eksHelmValues?: Record<string, unknown>;
