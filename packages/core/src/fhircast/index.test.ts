...
import {
  ...
  type FhircastConnectEvent,
  type FhircastDiagnosticReportOpenContext,
  type FhircastDiagnosticReportUpdateContext,
  type FhircastDisconnectEvent,
  type FhircastImagingStudyOpenContext,
  type FhircastMessageEvent,
