...
const HERO_CHIPS: HeroChip[] = [
  { id: 'auth', label: 'Auth', kind: 'Foundation', icon: <IconLock size={18} stroke={1.75} aria-hidden />, left: '50%', top: '8.2%', sx: 300, sy: 58, tx: 285, ty: 150, delay: 0 },
  { id: 'fhir', label: 'FHIR', kind: 'Foundation', icon: <IconDatabase size={18} stroke={1.75} aria-hidden />, left: '85%', top: '16.4%', sx: 480, sy: 92, tx: 350, ty: 185, delay: 80 },
  { id: 'billing', label: 'Billing', kind: 'Capability', icon: <IconReceipt size={18} stroke={1.75} aria-hidden />, left: '87%', top: '45.5%', sx: 472, sy: 205, tx: 350, ty: 240, delay: 160 },
  { id: 'access', label: 'Access', kind: 'Foundation', icon: <IconShieldLock size={18} stroke={1.75} aria-hidden />, left: '85%', top: '84.5%', sx: 475, sy: 356, tx: 330, ty: 275, delay: 240 },
  { id: 'bots', label: 'Bots', kind: 'Foundation', icon: <IconRobot size={18} stroke={1.75} aria-hidden />, left: '50%', top: '92.3%', sx: 300, sy: 388, tx: 185, ty: 292, delay: 320 },
  { id: 'charting', label: 'Charting', kind: 'Capability', icon: <IconNotes size={18} stroke={1.75} aria-hidden />, left: '17.5%', top: '84.5%', sx: 155, sy: 356, tx: 225, ty: 260, delay: 400 },
  { id: 'messaging', label: 'Messaging', kind: 'Capability', icon: <IconMessage size={18} stroke={1.75} aria-hidden />, left: '13%', top: '48.9%', sx: 128, sy: 215, tx: 210, ty: 255, delay: 480 },
  { id: 'scheduling', label: 'Scheduling', kind: 'Capability', icon: <IconCalendar size={18} stroke={1.75} aria-hidden />, left: '15%', top: '16.4%', sx: 120, sy: 90, tx: 190, ty: 228, delay: 560 },
];
