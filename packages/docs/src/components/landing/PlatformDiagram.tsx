...
const CATS = {
  medplum: {
    bg: C.purpleBg, border: C.purple, borderW: 2,
    iconColor: C.purple, iconBg: C.chipBg, iconBorder: C.purpleSoft
  },
  extensible: {
    bg: C.purpleStripe, border: C.purple, borderW: 2,
    iconColor: C.purple, iconBg: C.chipBg, iconBorder: C.purpleSoft
  },
  customer: {
    bg: C.bgGray, border: C.border, borderW: 1.5,
    iconColor: C.muted, iconBg: C.chipBg, iconBorder: C.border
  },
  partner: {
    bg: C.panel, border: C.border, borderW: 1.5,
    iconColor: C.muted, iconBg: C.chipBg, iconBorder: C.border
  }
};
...
function Card({
  ...
  return (
    <div ref={nodeRef} className={`${shadowClass} ${className}`} {...rest} style={{
      background: k.bg,
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      <div style={{
        ...
        background: k.bg,
        border: dashed
          ? `2.5px dashed ${C.dashed}`
          : `${k.borderW}px solid ${k.border}`,
        flexShrink: 0
      }} />
...
function Elbow({ points, color = C.line, dashed = false, w = 2 }) {
  ...
  return (
    <>
      <path d={d} fill="none" stroke={C.bgPage} strokeWidth={w + 4}
  ...
  return (
    <>
      <line x1={from.x} y1={from.y} x2={to.x} y2={to.y}
        stroke={C.bgPage} strokeWidth={w + 4} strokeLinecap="round" />
      <line x1={from.x} y1={from.y} x2={to.x} y2={to.y}
...
function MedplumDiagram({ active = null, peek = null, onSelect }) {
  ...
  }, [R.medplumIdp && R.medplumIdp.y, R.medplumIdp && R.medplumIdp.h,
      R.byoIdp && R.byoIdp.y, R.byoIdp && R.byoIdp.h]);
    ...
    <div className={styles.root} style={{
      ...
      <div ref={rootRef} style={{ maxWidth: 1180, margin: '0 auto', position: 'relative' }}>
        ...
        <svg style={{
          ...
          {R.subs && R.bot && R.intBox && R.platformBox && R.bridge && (() => {
        ...
        <div style={{ position: 'relative', zIndex: 2, marginBottom: 56,
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr',
            ...
            <Card nodeRef={refs.customApps} className={ctxClass} kind="customer" icon="apps" name="Custom Apps"
              style={{ borderBottomLeftRadius: 0, borderBottomRightRadius: 0, borderBottomWidth: 0 }} />
            <Card nodeRef={refs.medplumProv} className={ctxClass} kind="extensible" icon="stethoscope" name="Medplum Provider" sub="Example EHR"
              style={{ borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }} />
            <Card nodeRef={refs.medplumApp} className={ctxClass} kind="extensible" icon="appWindow" name="Medplum App" sub="Admin / Dev Console"
              style={{ borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }} />

            {/* Row 2 — React Storybook (foundation, clickable; badge on the middle copy) */}
            <Card {...clk('React Storybook')} kind="customer" dashed icon="layers" name="React Storybook" compact
              style={{ borderRadius: 0, borderBottomWidth: 0 }} />
            <Card {...clk('React Storybook')} badge={NUM['React Storybook']} kind="extensible" icon="layers" name="React Storybook" compact
              style={{ borderRadius: 0, borderTopWidth: 0 }} />
            <Card {...clk('React Storybook')} kind="extensible" icon="layers" name="React Storybook" compact
              style={{ borderRadius: 0, borderTopWidth: 0 }} />

            {/* Row 3 — TypeScript / JavaScript SDK (foundation, clickable; badge on the middle copy) */}
            <Card nodeRef={refs.sdkCustom} {...clk('TypeScript / JavaScript SDK')} kind="customer" dashed icon="code" name="TypeScript / JavaScript SDK" compact
              style={{ borderTopLeftRadius: 0, borderTopRightRadius: 0 }} />
            <Card nodeRef={refs.sdkProv} {...clk('TypeScript / JavaScript SDK')} badge={NUM['TypeScript / JavaScript SDK']} kind="extensible" icon="code" name="TypeScript / JavaScript SDK" compact
              style={{ borderTopLeftRadius: 0, borderTopRightRadius: 0, borderTopWidth: 0 }} />
            <Card nodeRef={refs.sdkApp} {...clk('TypeScript / JavaScript SDK')} kind="extensible" icon="code" name="TypeScript / JavaScript SDK" compact
              style={{ borderTopLeftRadius: 0, borderTopRightRadius: 0, borderTopWidth: 0 }} />
          </div>
          <div />
        </div>
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'grid',
          gridTemplateColumns: '1fr 240px', gap: 24, alignItems: 'start' }}>

          {/* CENTER: Medplum Platform */}
          <div style={{ position: 'relative' }} ref={refs.platformBox}>
            <div className={ctxClass} style={{
              position: 'absolute', top: -12, right: 22,
              background: C.hostedBg, color: 'white',
              fontSize: 11, fontWeight: 600, letterSpacing: '0.08em',
              padding: '4px 12px', borderRadius: 6,
              zIndex: 3
            }}>MEDPLUM HOSTED PLATFORM*</div>
            ...
            <div ref={refs.rbac} {...clk('Access Control & Tenancy', { band: true })} style={{
            ...
            <div style={{
              ...
              <div ref={refs.fhirApi} {...clk('FHIR Data Store & API', { band: true })} style={{
                ...
                <div style={{ fontSize: 14.5, fontWeight: 500, color: C.text, whiteSpace: 'nowrap' }}>FHIR REST API</div>
              </div>
              <div ref={refs.medplumIdp} {...clk('Medplum Auth', { band: true })} style={{
                display: 'flex', alignItems: 'center', gap: 11,
                padding: '16px 22px',
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <Card nodeRef={refs.subs} {...clk('Subscriptions')} badge={NUM['Subscriptions']} kind="extensible" icon="bell" name={'Webhook / WebSocket\nSubscriptions'} />
                <Card nodeRef={refs.bot} {...clk('Bots')} badge={NUM['Bots']} kind="extensible" icon="robot" name="Bots" />
              </div>
            </div>

            {/* Bottom band — FHIR Datastore (with nested Terminology sub-pill) */}
            <div ref={refs.datastore} {...clk('FHIR Data Store & API', { band: true })} style={{
              display: 'flex', alignItems: 'center', gap: 11,
              padding: '16px 22px',
              ...
              <div style={{ fontSize: 14.5, fontWeight: 500, color: C.text, whiteSpace: 'nowrap' }}>FHIR Datastore</div>
              <div style={{
                ...
                <span style={{ fontSize: 12.5, fontWeight: 500, color: C.text, whiteSpace: 'nowrap' }}>Terminology</span>
            ...
            {(() => {
              ...
              const w = PL.w, h = PL.h;
              const inset = 1, r = 18 - inset;
              const Tx = inset, Rx = w - inset;
              ...
              return (
                <svg style={{ position: 'absolute', left: 0, top: 0, width: w, height: h,
                  ...
                  <path d={path} fill="none" stroke={C.purple} strokeWidth="2.5"
                    strokeDasharray="6 4" strokeLinecap="butt" />
                </svg>);
            })()}
          </div>
          ...
          <div ref={refs.rightCol} style={{
            display: 'flex',
            flexDirection: 'column',
            marginTop: colShift
          }}>
            <div style={{ marginBottom: 22 }}>
              <Card nodeRef={refs.byoIdp} className={ctxClass} kind="customer" icon="key" dashed
              name="External Identity Provider" sub="Optional" />
            </div>
            ...
            <div style={{ marginBottom: 28 }}>
              <Card nodeRef={refs.bridge} {...clk('Medplum Bridge')} badge={NUM['Medplum Bridge']} kind="extensible" icon="fileTransfer"
              name="Medplum Bridge" sub="On-prem · HL7 / DICOM" />
            </div>

            <div ref={refs.intBox} className={ctxClass} style={{
              ...
              <div style={{
                ...
                background: C.intPillBg, color: C.text,
