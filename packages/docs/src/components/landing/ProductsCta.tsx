        ...
        <div className={styles.grid}>
          <div className={styles.copyCol}>
            ...
            <p className={styles.body}>
              Build and ship your own branded app with the workflows your organization needs, all running on our
              FHIR data model, auth, and APIs. You own the experience and we&apos;ll handle the infrastructure
              underneath.
            </p>
