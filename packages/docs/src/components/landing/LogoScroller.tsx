...
function Logos(): JSX.Element {
  return (
    <>
      ...
      <img src="/img/logos/radai.webp" width={133} height={51} alt="Rad AI" />
      <img src="/img/logos/imagine.webp" width={133} height={51} alt="Imagine" />
      <img src="/img/logos/tia.webp" width={133} height={36} alt="Tia" />
    </>
  );
}
