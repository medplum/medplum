        ...
        <div className={styles.section}>
          ...
          <div className={styles.servicesSection}>
            <ul>
              ...
              <li>
                We help digital health companies and providers create bespoke, connected experiences that give customers
                what they want, when they want it, while providing HIPAA compliance and SOC2 certification.
              </li>
            </ul>
          </div>
        </div>
        <div className={styles.section}>
          <div className={styles.servicesGrid}>
            <div className={styles.featureCell}>
              ...
              <p>
                All data is stored in FHIR, and we allow API access and streamlined payor and partner integrations from
                day 1. If required, we can enforce Google Authentication. If we host, we can sign a HIPAA BAA and have
                SOC2 Certification.
              </p>
            </div>
            <div className={styles.featureCell}>
              ...
              <p>
                We will deliver high quality code to a repository you own. You can self-host your application or we can
                host for you. We can set up your software development lifecycle, automatic deployment and testing. We
                can provide training and documentation for your dev team.
              </p>
            </div>
            <div className={styles.featureCell}>
              <div className={styles.featureIcon}>
