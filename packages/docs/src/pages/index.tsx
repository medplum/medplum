        ...
        <div className={styles.section}>
          <div className={styles.featureGrid}>
            ...
            <div className={styles.featureCell}>
              ...
              <h3>Open Source</h3>
              <p>
                Medplum's core technology is open source(Apache 2.0 license) and freely available in Github, so there is{' '}
                <strong>no risk of vendor lock-in</strong>.<br />
                <br />
            ...
            <div className={styles.featureCell}>
              ...
              <p>
                Healthcare operations involves tracking and managing complex tasks, from clinical procedures to billing
                and documentation.
                <em>
                  <br />
                </em>
            ...
            <div className={styles.featureCell}>
              ...
              <p>
                Healthcare data can be tricky. Medical edge cases are hard to anticipate, and data is fragmented across
                ecosystem partners.
                <br />
                <br />
