...
**[Naomi Carrigan](https://www.linkedin.com/in/naomi-lgbt/)** - is cultivating online communities for Deepgram, the voice AI platform for speech-to-text and text-to-speech APIs. She is founder of NHCarrigan, senior software engineer, community manager, developer educator, and all around girlboss.
