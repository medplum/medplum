...
March was yet another busy month for Medplum. Three patch releases — v5.1.2, v5.1.3, and v5.1.4 — arrived alongside over 100 commits from 20+ contributors, and the work underneath the surface was just as significant as the new features. Spaces gained richer AI tooling. The [communications documentation](/docs/communications) received a full suite of guides covering everything from the data model to automations. Worker infrastructure got a substantial rethink, and [WebSocket subscriptions](/docs/subscriptions) were hardened across the board. All of it continues to advance our [2026 roadmap priorities](/blog/2026-roadmap).
...
Spaces continues to advance our [AI roadmap initiative](/blog/2026-roadmap) and the [Provider Application roadmap goal](/docs/provider):
...
- **[Visit Templates and the SOAP Approach](/docs/charting/visit-templates)** — Visit templates tied to SOAP (structured S/O/P, narrative assessment) in clinical charting
