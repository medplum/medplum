...
- [Google Authentication](/docs/auth/idp/google-auth) and [External authentication](/docs/auth/idp/external-identity-providers) - Summer Health uses multiple identity providers for practitioners and patients respectively.
