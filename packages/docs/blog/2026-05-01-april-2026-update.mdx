...
April was another busy month for Medplum. Three patch releases — v5.1.7, v5.1.8, and v5.1.9 — arrived alongside 130+ commits from 20+ contributors. The Provider app's billing and coverage workflows took a major step forward with integrated claim submission and live eligibility visibility. [Scheduling](/docs/scheduling) added support for service line configurations on `HealthcareService`, aligning with R5/R6 FHIR conventions. Spaces, an AI-powered chat workspace feature inside the Provider App, gained speech-to-text and transparency into AI tool calls. Clinical documentation expanded across intake, care plans, diagnostics, authentication, and integrations. All of it continues to advance our [2026 roadmap priorities](/blog/2026-roadmap).
