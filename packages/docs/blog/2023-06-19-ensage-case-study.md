...
2. [Authentication](/docs/auth): Multiple authentication providers were utilized, with the EnSage team using [Google Authentication](/docs/auth/idp/google-auth), while referring physician identities were managed in an [Auth0 tenant](/docs/auth/idp/external-identity-providers).
