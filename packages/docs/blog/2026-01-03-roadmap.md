...
- 500,000+ Docker downloads
- 161 GitHub contributors
- 2,100 GitHub stars
...
Medplum is pursuing [HITRUST Certification](/docs/compliance/hitrust) for our hosted environment. We are also certifying changes related to [HTI-4](/docs/compliance/hti-4) to enable both providers and payers to comply with the mandate.
