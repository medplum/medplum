...
- Send an automated [charting note](/docs/charting/visit-templates) to Medplum based on a form filled in by a patient/care team member
...
- Case Study: [Awell Panels: Worklists That Update Themselves](/blog/awell-panels-case-study), how Panels runs post-discharge follow-up for 180+ facilities on self-hosted Medplum
- [Awell Panels walkthrough](https://youtu.be/pH7ME9FRPLY) and [building a Panel from scratch](https://youtu.be/e_jwOw4lo8E)
- [Community demos](/blog/plumcon-2026#community-demos) from PlumCon 2026
