...
const sidebars = {
  ...
  docsSidebar: [
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'client/classes/MedplumClient', label: 'MedplumClient' },
        {
          type: 'category',
          label: 'FHIR Types',
          link: { type: 'doc', id: 'fhirtypes/index' },
          items: [
            {
              type: 'autogenerated',
              dirName: 'fhirtypes/interfaces',
            },
          ],
        },
        { type: 'doc', id: 'client/modules', label: 'Utilities' },
      ],
    },
    {
      type: 'category',
