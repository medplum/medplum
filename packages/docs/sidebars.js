...
const sidebars = {
  ...
  docsSidebar: [
    ...
    },
    {
      ...
      items: [
        { type: 'html', value: '<strong class="menu__link">FHIR Data</strong>' },
        ...
        { type: 'html', value: '<strong class="menu__link">Migration</strong>' },
        ...
        {
          type: 'category',
          label: 'Modeling Your Provider Directory',
          link: { type: 'doc', id: 'fhir-datastore/provider-directory/index' },
          items: [{ type: 'autogenerated', dirName: 'fhir-datastore/provider-directory' }],
        },
        {
          type: 'category',
          label: 'Patient Dedupliaction Architectures',
          link: { type: 'doc', id: 'fhir-datastore/patient-deduplication/patient-deduplication' },
