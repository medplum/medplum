...
| Read | Tracked with read-receipt [`Task`](/docs/api/fhir/resources/task) resources; see [Read Receipts and Message Status](/docs/communications/read-receipts-and-message-status). |
