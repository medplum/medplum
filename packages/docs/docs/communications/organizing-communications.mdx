...
- Search and query patterns for thread lists, filters, and subscriptions — see [Searching and Querying Threads](/docs/communications/searching-and-querying-threads)
