---
sidebar_position: 3
title: Task-Based Message Response Tracking and Routing
...
# Task-Based Message Response Tracking and Routing
...
**Structured reason codes:** If you need standardized, queryable reason codes, create a [`Provenance`](/docs/api/fhir/resources/provenance) resource alongside the [`Task`](/docs/api/fhir/resources/task) update. `Provenance.reason` accepts coded values:
