...
You will also need the `email` project feature flag turned on to allow Bots to send emails. See [project feature flags](/docsdocs/self-hosting/project-settings#project-feature-flags).
