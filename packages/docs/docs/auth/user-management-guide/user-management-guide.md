...
- [Server scoped users](/docs/auth/project-vs-server-scoped-users#server-scoped-users)
- [Project scoped users](/docs/auth/project-vs-server-scoped-users#project-scoped-users)
