...
For full details on SDC annotation syntax, template resources, and FHIRPath rules, see [Structured Data Capture](/docs/questionnaires/structured-data-capture).
...
- [Structured Data Capture](/docs/questionnaires/structured-data-capture) — Full SDC annotation guide and `$extract` API details
