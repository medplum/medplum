...
|        [**RelatedPerson** ➡ **Patient**](#approach-2)        |                             Yes                              |                            Rarely                            |                    Individual Patient                    | <ul><li>Modeling insurance _beneficiaries_ and _subscribers_ </li><li>Parents acting on behalf of minors</li></ul> |
...
In many use cases involving adult patients, family members _do not_ participate in clinical and financial activities. Rather, they jus serve as only points of contact. In those situations, [Approach #1](#approach-1) provides a simple modeling approach that avoids the use of many different resource types.
