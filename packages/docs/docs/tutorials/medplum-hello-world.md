...
- Registered for a Medplum account. (If not [registration instructions](./register))
...
The first page of the demo asks you to sign in using the Medplum credentials you set up in the [registration tutorial](./register).
