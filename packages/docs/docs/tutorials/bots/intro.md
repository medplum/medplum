...
1. [Integrating Logistics (3PL) into your EHR](/docs/tutorials/bots/logistics-into-ehr)
2. [Consuming HL7 Feeds and Converting to FHIR](/docs/tutorials/bots/insurance-eligibility-check)
