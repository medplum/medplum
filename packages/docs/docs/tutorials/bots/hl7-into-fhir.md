...
If you want to receive a notification whenever a Patient (or other FHIR resource) is created, you can do so by creating a [Subscription](/docs/tutorials/bots/bots-basics#executing-automatically-using-a-subscription).
