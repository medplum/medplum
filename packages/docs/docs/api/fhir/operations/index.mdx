...
- [Project/$rate-limits](/docs/api/fhir/operations/project-rate-limits) - View FHIR interaction quota usage
...
- [User/$rescope](/docs/api/fhir/operations/user-rescope) - Move a user between server and project scope
