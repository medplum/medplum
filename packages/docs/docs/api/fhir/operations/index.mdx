...
- [Patient/$set-accounts](/docs/api/fhir/operations/patient-set-accounts) - Set patient financial accounts
...
- [Subscription/$get-ws-binding-token](/docs/api/fhir/operations/subscription-get-ws-binding-token) - Get WebSocket binding token
