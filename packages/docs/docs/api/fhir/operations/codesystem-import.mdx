...
Each invocation of the `$import` operation can send a maximum of 1,000 of each parameter at a time,
e.g. importing 1,000 concepts with one property and one designation each per request.
