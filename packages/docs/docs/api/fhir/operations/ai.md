...
The `$ai` operation enables integration with OpenAI's language models through a FHIR-compliant interface. This operation allows you to leverage AI capabilities for conversational interactions and FHIR function calling within your healthcare applications.
  ...
  parameter: [
    {
      ...
      valueString: JSON.stringify([
        { role: 'user', content: 'What is FHIR?' }
      ])
    },
    {
      name: 'apiKey',
  ...
  parameter: [
    {
      name: 'messages',
      valueString: JSON.stringify([
        { role: 'user', content: 'Create a patient named John Smith' }
      ])
    },
    {
      name: 'apiKey',
