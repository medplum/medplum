...
For Medplum best practices on using the `MedicationDispense` resource, please refer to [Representing Prescriptions and Medication Orders](/docs/medications/representing-prescriptions-and-medication-orders).
