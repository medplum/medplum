...
All MEDrecord code lives in the `mrd/` folder to enable safe upstream Medplum sync. See [Upstream Sync Strategy](/docs/architecture/upstream-sync) for details.
