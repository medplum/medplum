...
| `dosespotMaxClinicians`        | integer | The maximum number of clinicians the [DoseSpot enrollment bots](/docs/integration/dosespot/enroll-user#enrollment-limit-guard-rail) may enroll in the Project. When the limit is reached, the bots stop enrolling new clinicians           | unlimited |
