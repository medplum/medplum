...
| `userFhirQuota`                | integer | The maximum FHIR interaction quota that can be performed in a minute by any single User in this project. See [Fhir Interaction Quota](/docs/compliance/rate-limits#fhir-interaction-load-rate-limit). To enforce, set `enableFhirQuota` to true. | 50000   |
