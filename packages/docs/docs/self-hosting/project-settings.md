...
| `totalFhirQuota`               | integer | The maximum number of FHIR interactions that can be performed in a minute for any user in the project. See [Fhir Interaction Quota](/docs/rate-limits#fhir-interaction-quota). To enforce, set `enableFhirQuota` to true. | 50000   |
