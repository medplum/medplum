...
| `totalFhirQuota`               | integer | The maximum number of FHIR interactions that can be performed in a minute for any user in the project. See [Fhir Interaction Quota](/docs/compliance/rate-limits#fhir-interaction-load-rate-limit). To enforce, set `enableFhirQuota` to true. | 50000   |
