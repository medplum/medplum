...
| `rdsInstanceParameters`       | Optional [AWS Aurora Postgres parameters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Reference.ParameterGroups.html).                                                                                                                                          |
...
| `rdsReaderInstanceParameters` | Optional [AWS Aurora Postgres parameters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Reference.ParameterGroups.html) for the reader instances. Default value is `rdsInstanceParameters`. See [Upgrade RDS Database](/docs/self-hosting/upgrade-rds-database).  |
