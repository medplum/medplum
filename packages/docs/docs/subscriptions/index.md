...
- [Subscriptions](https://app.medplum.com/Subscription) can be created and updated on the [Medplum App](../app)
- Subscriptions are commonly used with [bots](../bots/bot-for-questionnaire-response/bot-for-questionnaire-response) and [questionnaires](../questionnaires) to enable complex workflows.
...
- [Subscription Extensions](./subscription-extensions) describes advanced subscription features that allow more fine-grained control and security
