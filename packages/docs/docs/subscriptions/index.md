...
- Subscriptions are commonly used with [bots](../bots/bot-for-questionnaire-response/bot-for-questionnaire-response.md) and [questionnaires](../administration/provider-directory/questionnaires/index.md) to enable complex workflows.
