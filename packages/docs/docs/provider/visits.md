...
The Vital Signs Assessment questionnaire above uses [Structured Data Capture (SDC)](/docs/questionnaires/parsing-questionnaire-responses) patterns to automatically extract `Observation` resources from questionnaire responses. Each vital sign item includes:
