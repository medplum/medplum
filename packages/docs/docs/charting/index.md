...
The [Charting Decision Guide](/docs/decision-guides/charting) walks through requirements questions and FHIR modeling decisions for charting — use it alongside these docs.
:::
