...
| code | 0.._ | CodeableConcept | Definition of the role the participatingOrganization plays
| specialty | 0.._ | CodeableConcept | Specific specialty of the participatingOrganization in the context of the role
| location | 0.._ | Reference | The location(s) at which the role occurs
| healthcareService | 0.._ | Reference | Healthcare services provided through the role
| telecom | 0.._ | ContactPoint | Contact details at the participatingOrganization relevant to this Affiliation
| endpoint | 0.._ | Reference | Technical endpoints providing access to services operated for this role
