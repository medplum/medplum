...
The [E-Prescribe Decision Guide](/docs/decision-guides/e-prescribe) walks through requirements questions and FHIR modeling decisions for e-prescribing — use it alongside these docs.
:::
