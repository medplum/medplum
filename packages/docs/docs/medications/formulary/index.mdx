...
- How to represent compounded medications, including parent-child hierarchies for dose variations. 
...
### Parent-Child Medication Hierarchies
...
```ts
{
  ...
  ingredient: [
    {
      itemReference: {
        reference: "Substance/019634ac-de53-76ca-a8bf-460dd24db528",
        display: "Semaglutide"
      },
      strength: {
        numerator: {
    ...
    {
      itemReference: {
        reference: "Substance/01967df7-6af3-734a-8210-4a71220229c8",
        display: "Glycine"
      },
      strength: {
        numerator: {
