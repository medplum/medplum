...
See [Prescriber Enrollment](/docs/integration/dosespot/enroll-user) for the canonical guide to admin-driven and self-service enrollment, Practitioner requirements, EPCS setup, bot inputs and responses, and troubleshooting.
