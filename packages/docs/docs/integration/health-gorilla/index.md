...
[Health Information Exchange guide](/docs/integration/health-information-exchange). The HIE integration
is currently available only in production; Health Gorilla has not yet provided a sandbox workflow for
end-to-end HIE testing.
:::
