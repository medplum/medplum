...
Clients can pass in their own trace id in their request headers. Medplum supports `X-TRACE-ID`, `traceParent`, and [`Sentry-Trace`](https://develop.sentry.dev/sdk/distributed-tracing) headers.
