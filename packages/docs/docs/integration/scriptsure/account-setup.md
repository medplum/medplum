...
```
Can you create an example NPI for <full_name> in California. Please include a State Medical License Number and DEA as well.
```
...
2. Select **Add User** and choose **Provider**.
3. Enter the user's name and email. Grant **Full Administrator** access for admins.
4. Submit and acknowledge the confirmation dialog.
5. Once the new user accepts their invite, they can be designated as a prescriber or admin in the portal.
