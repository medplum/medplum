...
When wrapping your app in a `MedplumProvider`, you should be aware of the lifecycle events of `MedplumClient`. Each of the lifecycle events will trigger a rerender at the root of your; 
