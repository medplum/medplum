...
import ExampleCode from '!!raw-loader!@site/../examples/src/react/use-subscription.tsx';
...
Any [Subscription extension](../subscriptions/subscription-extensions) supported by Medplum can be attached to a `Subscription`
...
<MedplumCodeBlock language="tsx" selectBlocks="lifecycleHooks">
  {ExampleCode}
</MedplumCodeBlock>
...
Locally, you can enable this feature flag by logging in as a [super admin](../self-hosting/super-admin-guide)
