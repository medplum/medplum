...
<MedplumCodeBlock language="ts" selectBlocks="searchInclude">
  {ExampleCode}
</MedplumCodeBlock>

<details>
  <summary>Example Response</summary>
  <MedplumCodeBlock language="ts" selectBlocks="includeResponse">
    {ExampleCode}
  </MedplumCodeBlock>
</details>

<MedplumCodeBlock language="ts" selectBlocks="searchRevinclude">
  {ExampleCode}
</MedplumCodeBlock>

<details>
  <summary>Example Response</summary>
  <MedplumCodeBlock language="ts" selectBlocks="revincludeResponse">
    {ExampleCode}
  </MedplumCodeBlock>
</details>
