...
3. [Design your workflows](./docs/decision-guides) using our decision guides to scope intake, charting, referrals, messaging, access control, billing, and e-prescribing before you build.
...
5. [Migrate your data](./docs/migration) to Medplum.
