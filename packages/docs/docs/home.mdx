...
3. Explore our [Clinical Workflows](/docs/charting) guides! Popular workflows are included below. Step through specific use cases. Don't see a how-to guide you need? Reach out on our [Discord](https://discord.gg/medplum) or send us an email at [support@medplum.com](mailto:support@medplum.com).
...
Medplum is [open source](https://github.com/medplum/medplum). [Reference material](/docs/api/index.md) and [sample applications](https://github.com/medplum) are available for browsing without authentication.
