...
3. [Design your workflows](./docs/decision-guides) using our decision guides to scope intake, charting, referrals, messaging, and access control before you build.
