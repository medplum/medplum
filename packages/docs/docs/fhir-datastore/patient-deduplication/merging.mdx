...
See the [`linkPatientRecords`](/docs/sdk/core.linkpatientrecords) function in the SDK documentation for implementation details.
...
See the [`mergePatientRecords`](/docs/sdk/core.mergepatientrecords) function in the SDK documentation for implementation details.
...
See the [`replaceReferences`](/docs/sdk/core.replacereferences) function in the SDK documentation for implementation details.
...
For a complete example implementation, see the [patient deduplication demo bot](https://github.com/medplum/medplum/blob/main/examples/medplum-demo-bots/src/deduplication/merge-matching-patients.ts).
