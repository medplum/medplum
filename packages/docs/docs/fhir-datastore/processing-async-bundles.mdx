...
Asynchronous batch processing requires the `async-batch` feature flag on your Medplum Project. For Medplum-hosted environments, contact [support@medplum.com](mailto:support@medplum.com) to have it enabled.
