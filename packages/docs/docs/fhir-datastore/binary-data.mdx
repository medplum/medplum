...
First, the `Authorization` header is required to authenticate the request. See the [**Client Credentials tutorial**](/docs/auth/authentication-methods/client-credentials) guide for how to obtain an access token.
...
See the [**Client Credentials tutorial**](/docs/auth/authentication-methods/client-credentials) guide for how to obtain an access token
