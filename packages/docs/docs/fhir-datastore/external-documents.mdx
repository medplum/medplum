...
import ExampleCode from '!!raw-loader!@site/../examples/src/fhir-datastore/external-documents.ts';
import MedplumCodeBlock from '@site/src/components/MedplumCodeBlock';

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# External Files and Document References
...
- [Binary Data](/docs/fhir-datastore/binary-data)
- [Creating a PDF File from a Bot](/docs/bots/creating-a-pdf)
- [Chart Data Model](/docs/charting/chart-data-model) — where external documents appear in patient context
