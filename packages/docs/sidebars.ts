        ...
        { type: 'autogenerated', dirName: 'api/auth' },
        {
          ...
          items: [
            { type: 'doc', id: 'api/fhir/overview' },
            {
              type: 'category',
              label: 'Data Types',
              link: { type: 'generated-index', slug: '/api/fhir/datatypes', title: 'FHIR Data Types', description: 'FHIR Data Type Reference' },
              items: [{ type: 'autogenerated', dirName: 'api/fhir/datatypes' }],
            },
            {
              type: 'category',
              label: 'Medplum',
              link: { type: 'generated-index', slug: '/api/fhir/medplum', title: 'Medplum Resources', description: 'Medplum Resource Reference' },
            ...
            },
            {
              type: 'category',
              label: 'Resources',
              link: { type: 'generated-index', slug: '/api/fhir/resources', title: 'FHIR Resources', description: 'FHIR Resource Reference' },
