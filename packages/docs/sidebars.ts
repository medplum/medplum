...
const sidebars: SidebarsConfig = {
  docsSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Referrals',
      link: { type: 'doc', id: 'referrals/index' },
      items: [{ type: 'autogenerated', dirName: 'referrals' }],
    },
    {
      type: 'category',
      label: 'Scheduling',
    ...
    },
    {
      ...
      items: [
        { type: 'doc', id: 'integration/health-gorilla/hg-changelog', label: 'Changelog' },
        { type: 'autogenerated', dirName: 'integration/health-gorilla' },
      ],
    },
    {
      type: 'category',
