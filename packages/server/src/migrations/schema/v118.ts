...
export async function run(client: PoolClient): Promise<void> {
  ...
  await fns.query(client, results, `ALTER TABLE IF EXISTS "PractitionerRole" ADD COLUMN IF NOT EXISTS "network" TEXT[]`);
  await fns.query(client, results, `ALTER TABLE IF EXISTS "PractitionerRole" ADD COLUMN IF NOT EXISTS "__networkIdentifierSort" TEXT`);
  ...
  "studyId" TEXT,
  "__studyDate" DATERANGE,
  "__studyDateSort" DATE,
  "studyDate" DATE,
  "studyTime" TEXT,
  ...
  await fns.query(client, results, `CREATE INDEX IF NOT EXISTS "DicomStudy___studyDate_sorted_idx" ON "DicomStudy" USING gist ("__studyDate", "__studyDateSort")`);
