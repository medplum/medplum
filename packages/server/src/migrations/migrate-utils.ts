...
/**
 * Converts Unicode characters matching /\x01-\x1F\x7F-\uFFFF/ to their
 * escaped representation. Excludes tabs, carriage returns, and line feeds.
 * Useful when writing SQL to files.
 * - ASCII control chars (0x00-0x1F) and DEL (0x7F) use \x format
 * - All other chars use \u format
