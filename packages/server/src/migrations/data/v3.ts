...
import { PostDeployMigrationAction, PostDeployMigrationResult } from './migration';
...
export async function processPostDeploy(): Promise<PostDeployMigrationResult> {
...
export async function runQueries(actions: PostDeployMigrationAction[], client: Pool | PoolClient): Promise<void> {
  ...
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "Account_tokensTrgm_idx" ON "Account" USING gin (token_array_to_text("tokensText") gin_trgm_ops)'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "ActivityDefinition_tokens_idx" ON "ActivityDefinition" USING gin ("tokens")'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "ActivityDefinition_tokensTrgm_idx" ON "ActivityDefinition" USING gin (token_array_to_text("tokensText") gin_trgm_ops)'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "AdverseEvent_tokens_idx" ON "AdverseEvent" USING gin ("tokens")'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "AdverseEvent_tokensTrgm_idx" ON "AdverseEvent" USING gin (token_array_to_text("tokensText") gin_trgm_ops)'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "AllergyIntolerance_tokens_idx" ON "AllergyIntolerance" USING gin ("tokens")'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "AllergyIntolerance_tokensTrgm_idx" ON "AllergyIntolerance" USING gin (token_array_to_text("tokensText") gin_trgm_ops)'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "Appointment_tokens_idx" ON "Appointment" USING gin ("tokens")'
  );
  await query(
    context,
    'CREATE INDEX CONCURRENTLY IF NOT EXISTS "Appointment_tokensTrgm_idx" ON "Appointment" USING gin (token_array_to_text("tokensText") gin_trgm_ops)'
  );
  await query(
    context,
