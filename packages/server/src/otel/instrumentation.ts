...
import { diag, DiagConsoleLogger, DiagLogLevel, type Span, SpanStatusCode } from '@opentelemetry/api';
...
import { PgInstrumentation, type PgResponseHookInformation } from '@opentelemetry/instrumentation-pg';
