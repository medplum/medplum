...
- R = Required, U = Unique, C = Conditional
...
| Rows                     | (0028,0010) | C    | Shall be present if known                                                   |
| Columns                  | (0028,0011) | C    | Shall be present if known                                                   |
| Bits Allocated           | (0028,0100) | C    | Shall be present if known                                                   |
| Number of Frames         | (0028,0008) | C    | Shall be present if known                                                   |
