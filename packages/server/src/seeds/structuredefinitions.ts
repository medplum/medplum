...
export async function createStructureDefinitions(): Promise<void> {
  ...
  createStructureDefinitionsForBundle(readJson('fhir/r4/profiles-resources.json') as Bundle);
  createStructureDefinitionsForBundle(readJson('fhir/r4/profiles-medplum.json') as Bundle);
}
