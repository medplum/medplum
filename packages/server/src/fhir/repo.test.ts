...
describe('FHIR Repo', () => {
  ...
  describe('Nested readonly fields', () => {
    test('Repository restores nested readonly fields from original on update', () =>
      withTestContext(async () => {
    ...
    test('Repository prevents modification of nested readonly fields', () =>
      withTestContext(async () => {
        const originalUserRef = 'User/' + randomUUID();
    ...
    test('Repository restores nested readonly fields even when parent object is modified', () =>
      withTestContext(async () => {
        const originalUserRef = 'User/' + randomUUID();
        const membership = await systemRepo.createResource<ProjectMembership>({
          resourceType: 'ProjectMembership',
    ...
    test('Repository handles deeply nested readonly fields with array indices', () =>
      withTestContext(async () => {
    ...
    test('Repository does not restore nested readonly fields if parent object does not exist in input', () =>
      withTestContext(async () => {
        const originalSystem = 'https://example.com/system';
        const patient = await systemRepo.createResource<Patient>({
          resourceType: 'Patient',
