...
abstract class Executable implements Expression {
  ...
  async execute<T = any>(conn: PgClientLike): Promise<T[]> {
...
export class UnionAllBuilder {
  ...
  async execute(conn: PgClientLike): Promise<any[]> {
...
export class SqlBuilder {
  ...
  async execute(conn: PgClientLike): Promise<{ rowCount: number; rows: any[] }> {
