...
export abstract class LookupTable {
   ...
   */
  async deleteValuesForResource(client: PgClientLike, resource: WithId<Resource>): Promise<void> {
  ...
  async batchDeleteValuesForResources<T extends Resource>(client: PgClientLike, resources: T[]): Promise<void> {
  ...
  protected static async purge(client: PgClientLike, lookupTableName: string, ...joins: TableJoin[]): Promise<void> {
