...
// The units and the arithmetic live in `@medplum/core` so that a client reading
// the same parameters agrees with us on how long a duration is; the diagnostics
// stay here, where the extension's path is known.
