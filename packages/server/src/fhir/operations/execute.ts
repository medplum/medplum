...
async function runInLambda(bot: Bot, context: any): Promise<any> {
  ...
  console.log(logBuffer.toString('ascii'));
...
async function runInVmContext(bot: Bot, context: any): Promise<any> {
  const sandbox = {
    ...context,
    assertOk,
    createReference,
