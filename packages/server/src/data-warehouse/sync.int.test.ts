...
/** Integration tests for sync.ts: Postgres (medplum_test) → syncData → Parquet on disk. Worker wiring is tested in workers/data-warehouse-sync.worker.int.test.ts. */
