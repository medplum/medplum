...
// created with jq 'del(.text, .differential, .mapping, .snapshot.element[].mapping)' StructureDefinition-us-core-patient.json

export const USCorePatientProfile: StructureDefinition = {
    ...
    element: [
      {
        ...
        constraint: [
          ...
          },
          {
            ...
            severity: 'error',
            human:
              'Either Patient.name.given and/or Patient.name.family SHALL be present or a Data Absent Reason Extension SHALL be present.',
            expression:
            ...
            xpath:
              "(/f:name/f:extension/@url='http://hl7.org/fhir/StructureDefinition/data-absent-reason' and not(/f:name/f:family or /f:name/f:given)) or (not(/f:name/f:extension/@url='http://hl7.org/fhir/StructureDefinition/data-absent-reason') and (/f:name/f:family or /f:name/f:given))",
          },
        ],
        mustSupport: false,
        isModifier: false,
      ...
      },
      {
        ...
        comment:
          'The codes required are intended to present birth sex (i.e., the sex recorded on the patient’s birth certificate) and not gender identity or reassigned sex.',
        min: 0,
        max: '1',
        base: {
          path: 'DomainResource.extension',
...
export const USCoreRaceExtension: StructureDefinition = {
  resourceType: 'StructureDefinition',
  id: 'us-core-race',
...
export const USCoreEthnicityExtension: StructureDefinition = {
  resourceType: 'StructureDefinition',
...
export const USCoreBirthSexExtension: StructureDefinition = {
  resourceType: 'StructureDefinition',
  id: 'us-core-birthsex',
...
export const USCoreGenderIdentityExtension: StructureDefinition = {
  resourceType: 'StructureDefinition',
