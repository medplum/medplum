...
import type { Immunization, ImmunizationPerformer, Organization, Practitioner } from '@medplum/fhirtypes';
...
import type { CcdaCode, CcdaEntry, CcdaId, CcdaPerformer, CcdaSubstanceAdministration } from '../../types';
