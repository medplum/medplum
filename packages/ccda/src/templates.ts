...
// QRDA Template Constants
export const QRDA_CATEGORY_I_REPORT_TEMPLATE_IDS: CcdaTemplateId[] = [
...
export const QRDA_REPORTING_PARAMETERS_SECTION_TEMPLATE_IDS: CcdaTemplateId[] = [
...
export const QRDA_ENCOUNTER_PERFORMED_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_ENCOUNTER_PERFORMED, '@_extension': '2021-08-01' },
];

export const QRDA_INTERVENTION_PERFORMED_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_INTERVENTION_PERFORMED, '@_extension': '2021-08-01' },
];

export const QRDA_PROCEDURE_PERFORMED_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_PROCEDURE_PERFORMED, '@_extension': '2021-08-01' },
];

export const QRDA_PATIENT_CHARACTERISTIC_PAYER_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_PATIENT_CHARACTERISTIC_PAYER },
];

export const QRDA_ENCOUNTER_DIAGNOSIS_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_ENCOUNTER_DIAGNOSIS, '@_extension': '2019-12-01' },
];

export const QRDA_RANK_TEMPLATE_IDS: CcdaTemplateId[] = [{ '@_root': OID_QRDA_RANK, '@_extension': '2019-12-01' }];

export const QRDA_AUTHOR_DATETIME_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_AUTHOR_DATETIME, '@_extension': '2019-12-01' },
];

export const QRDA_NEGATION_RATIONALE_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_NEGATION_RATIONALE, '@_extension': '2017-08-01' },
];

export const QRDA_ENCOUNTER_CLASS_TEMPLATE_IDS: CcdaTemplateId[] = [
  { '@_root': OID_QRDA_ENCOUNTER_CLASS, '@_extension': '2021-08-01' },
];

export const QRDA_PATIENT_DATA_SECTION_LEGACY_TEMPLATE_IDS: CcdaTemplateId[] = [
