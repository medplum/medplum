...
export const themePresets: ThemePreset[] = [
  { id: 'medplumDefault', name: 'Medplum Default', theme: medplumDefault },
  { id: 'foomedical', name: 'Foo Medical', theme: fooMedical },
  { id: 'bonfoo', name: 'Bon Foo', theme: bonFoo },
  { id: 'plumMedical', name: 'PlumMedical', theme: plumMedical },
  { id: 'materialUi', name: 'Material UI', theme: materialUi },
  { id: 'sci-fi', name: 'SciFi', theme: sciFi },
  { id: 'cursive', name: 'Cursive', theme: cursive },
  { id: 'caesar', name: 'Caesar', theme: caesar },
  { id: 'word-art', name: 'Word Art', theme: wordArt },
];

export const themePresetMap: Record<string, MantineThemeOverride> = Object.fromEntries(
  themePresets.map((preset) => [preset.id, preset.theme])
);
