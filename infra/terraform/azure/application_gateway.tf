...
# resource "azurerm_public_ip" "server_ip" {
#   name                = "${local.resource_prefix}-server-ip"
...
# output "api_ip" {
#   value = azurerm_public_ip.server_ip.ip_address
# }

# resource "azurerm_application_gateway" "server_appgw" {
#   name                = "${local.resource_prefix}-server-appgw"
#   resource_group_name = azurerm_resource_group.rg.name
#   location            = var.location
...
#     public_ip_address_id = azurerm_public_ip.server_ip.id
#   }
