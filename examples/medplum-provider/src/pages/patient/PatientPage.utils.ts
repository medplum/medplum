...
export const PatientPageTabs: PatientPageTabInfo[] = [
  ...
  {
    id: 'encounter',
    url: 'Encounter?_count=20&_fields=_lastUpdated,status,period,class,type,diagnosis,hospitalization&_sort=-_lastUpdated&subject=%patient.id',
    label: 'Encounters',
  },
  {
    id: 'procedure',
    url: 'Procedure?_count=20&_fields=_lastUpdated,status,period,code,category,performed,statusReason&_sort=-_lastUpdated&subject=%patient.id&category=103693007',
    label: 'Procedures',
  },
  {
    id: 'intervention',
    url: 'Procedure?_count=20&_fields=_lastUpdated,status,period,code,category,performed,statusReason&_sort=-_lastUpdated&subject=%patient.id&category=409063005',
    label: 'Interventions',
  },
  {
    id: 'coverage',
    url: 'Coverage?_count=20&_fields=_lastUpdated,status,period,type&_sort=-_lastUpdated&beneficiary=Patient/%patient.id',
    label: 'Coverages',
  },
  {
    id: 'document',
    url: 'Media?_count=20&_fields=_lastUpdated,status,content&_sort=-_lastUpdated&subject=%patient.id',
    label: 'Documents',
  },
  // {
  //   id: 'encounter',
