...
import { createReference, MedplumClient, getStatus, isOperationOutcome, ContentType } from '@medplum/core';
...
describe('Deduplication', () => {
  ...
  test('Source has a replaced-by link', async () => {
    ...
    mockMedplumClient.readReference = vi.fn().mockResolvedValue(mockMasterPatient);
