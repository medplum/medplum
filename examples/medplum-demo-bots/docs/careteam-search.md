...
A FHIR transaction Bundle is included at [`data/careteam-search-sample.json`](../data/careteam-search-sample.json). Load it into your Medplum project to try the bot:
