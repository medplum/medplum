...
import { IconBuildingCommunity, IconUser, IconUserPlus, IconBuildingHospital, IconStethoscope, IconReportMedical, IconNurse, IconMessage, IconUpload, IconHome } from '@tabler/icons-react';
