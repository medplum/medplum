      ...
      <AppShell.Header px="md">
        <Container h="100%">
          <Group justify="space-between" h="100%">
            <UnstyledButton className={classes.logoButton} onClick={() => void navigate('/')}>
              <Logo width={240} />
            </UnstyledButton>
            ...
            <Group className={classes.hiddenMobile}>
              <Button variant="default" onClick={() => void navigate('/signin')}>
                Log in
              </Button>
              <Button onClick={() => void navigate('/register')}>Sign up</Button>
            </Group>
