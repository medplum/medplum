 ...
 * A length of time.
 */
public class Duration extends FhirObject {
    ...
    public Duration(final JsonObject data) {
        super(data);
    }
    ...
    public static final class Builder extends FhirObject.Builder<Duration, Duration.Builder> {
