...
public class Distance extends FhirObject {
    ...
    public Distance(final JsonObject data) {
        super(data);
    }
    ...
    public static final class Builder extends FhirObject.Builder<Distance, Distance.Builder> {
