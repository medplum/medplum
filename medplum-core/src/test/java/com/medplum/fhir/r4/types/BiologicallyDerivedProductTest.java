...
public class BiologicallyDerivedProductTest {
    ...
    public void testConstructor() {
        assertNotNull(new BiologicallyDerivedProduct(Json.createObjectBuilder().build()));
    }

    @Test
    public void testBuilderFromJsonObject() {
        assertNotNull(BiologicallyDerivedProduct.create(Json.createObjectBuilder().build()).build());
    }
    ...
    public void testImplicitRules() {
        ...
        assertEquals(value, BiologicallyDerivedProduct.create().implicitRules(value).build().implicitRules());
    }
    ...
    public void testExtension() {
        ...
        assertEquals(value, BiologicallyDerivedProduct.create().extension(value).build().extension());
    }
