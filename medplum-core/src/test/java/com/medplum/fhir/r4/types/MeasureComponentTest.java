...
public class MeasureComponentTest {
    ...
    public void testConstructor() {
        assertNotNull(new Measure.MeasureComponent(Json.createObjectBuilder().build()));
    }

    @Test
    public void testBuilderFromJsonObject() {
        assertNotNull(Measure.MeasureComponent.create(Json.createObjectBuilder().build()).build());
    }

    @Test
    public void testCopyAll() {
        final Measure.MeasureComponent x = Measure.MeasureComponent.create().build();
        final Measure.MeasureComponent y = Measure.MeasureComponent.create().copyAll(x).build();
        assertEquals(x, y);
    }
    ...
    public void testExtension() {
        ...
        assertEquals(value, Measure.MeasureComponent.create().extension(value).build().extension());
    }
