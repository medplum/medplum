...
public class FlagTest {
    ...
    public void testConstructor() {
        assertNotNull(new Flag(Json.createObjectBuilder().build()));
    }

    @Test
    public void testBuilderFromJsonObject() {
        assertNotNull(Flag.create(Json.createObjectBuilder().build()).build());
    }
    ...
    public void testImplicitRules() {
        ...
        assertEquals(value, Flag.create().implicitRules(value).build().implicitRules());
    }
    ...
    public void testExtension() {
        ...
        assertEquals(value, Flag.create().extension(value).build().extension());
    }
