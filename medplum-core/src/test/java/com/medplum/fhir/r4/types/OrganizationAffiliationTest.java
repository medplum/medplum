...
public class OrganizationAffiliationTest {
    ...
    public void testConstructor() {
        assertNotNull(new OrganizationAffiliation(Json.createObjectBuilder().build()));
    }

    @Test
    public void testBuilderFromJsonObject() {
        assertNotNull(OrganizationAffiliation.create(Json.createObjectBuilder().build()).build());
    }
    ...
    public void testImplicitRules() {
        ...
        assertEquals(value, OrganizationAffiliation.create().implicitRules(value).build().implicitRules());
    }
    ...
    public void testExtension() {
        ...
        assertEquals(value, OrganizationAffiliation.create().extension(value).build().extension());
    }
