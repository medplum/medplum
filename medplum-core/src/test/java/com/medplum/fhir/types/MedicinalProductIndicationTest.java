...
public class MedicinalProductIndicationTest {
    ...
    public void testResourceType() {
        assertEquals("x", MedicinalProductIndication.create().resourceType("x").build().resourceType());
    }
    ...
    public void testImplicitRules() {
        assertEquals("x", MedicinalProductIndication.create().implicitRules("x").build().implicitRules());
    }
