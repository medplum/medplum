...
public class CoverageEligibilityRequestTest {
    ...
    public void testResourceType() {
        assertEquals("x", CoverageEligibilityRequest.create().resourceType("x").build().resourceType());
    }
    ...
    public void testImplicitRules() {
        assertEquals("x", CoverageEligibilityRequest.create().implicitRules("x").build().implicitRules());
    }
