...
public class MedicinalProductPharmaceuticalTest {
    ...
    public void testResourceType() {
        assertEquals("x", MedicinalProductPharmaceutical.create().resourceType("x").build().resourceType());
    }
    ...
    public void testImplicitRules() {
        assertEquals("x", MedicinalProductPharmaceutical.create().implicitRules("x").build().implicitRules());
    }
