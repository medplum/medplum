...
public class SubstanceSourceMaterialTest {
    ...
    public void testResourceType() {
        assertEquals("x", SubstanceSourceMaterial.create().resourceType("x").build().resourceType());
    }
    ...
    public void testImplicitRules() {
        assertEquals("x", SubstanceSourceMaterial.create().implicitRules("x").build().implicitRules());
    }
